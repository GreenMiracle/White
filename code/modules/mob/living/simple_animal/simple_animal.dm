...
/mob/living/simple_animal/attack_animal(mob/living/simple_animal/M as mob)
	if(M.melee_damage_upper == 0)
		...
		M.attack_log += text("\[[time_stamp()]\] <font color='red'>Attacked [src.name] ([src.ckey])(Animal)</font>")
		src.attack_log += text("\[[time_stamp()]\] <font color='orange'>Was attacked by [M.name] ([M.ckey])(Animal)</font>")
		log_attack("[M.name] ([M.ckey]) attacked [src.name] ([src.ckey])(Animal)")
...
/mob/living/simple_animal/attack_metroid(mob/living/carbon/metroid/M as mob)
	if (!ticker)
